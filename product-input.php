				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header bg-white py-3">
							<h5 class="m-0 text-primary">Add Product</h5>
						</div>
						<div class="card-body">
							<form action="product-insert.php" method="POST">
								<div class="row text-dark mx-4">
									<input type="hidden" name="UserCreated" value="<?php echo $_SESSION['Username']; ?>">
									<div class="col-sm-7">
										<div class="row mb-3">
											<div class="col-sm-3"><label>Name</label></div>
											<div class="col-sm-8"><input class="form-control" type="text" name="InventoryName" placeholder="Enter Name"></div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3"><label>Image</label></div>
											<div class="col-sm-8"><input class="form-control" type="file" name="Image"></div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3"><label>Volume</label></div>
											<div class="col-sm-8"><input class="form-control" type="text" name="Volume" placeholder="P x L x T"></div>
										</div>
									</div>
									<div class="col-sm-5">
										<div class="row mb-3">
											...
											<div class="col-sm-8">
												<div class="input-group">
													...
													<input class="form-control" type="number" name="BuyPrice" placeholder="Enter Buy Price">
												</div>
											</div>
										</div>
										<div class="row mb-4">
										...
										<div class="row">
											...
											<div class="col-sm-5"><input type="submit" name="save" value="Save Product" class="btn btn-primary btn-block shadow"></div>
										</div>
									</div>
								</div>
							</form>
